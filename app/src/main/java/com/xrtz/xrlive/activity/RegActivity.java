                                ...
                                public void call(UserResponse userResponse) {
                                    ...
                                    if (userResponse!=null) {
                                        if(userResponse.getStatus()==1){//成功
                                           ...
                                           /*如果选择记住密码，缓存账号密码*/
                                            SharePreference.putBoolean(RegActivity.this,REMMEMBERUSER, LiveApplication.rememberuser);
                                            if(LiveApplication.rememberuser){
                                                SharePreference.putString(RegActivity.this,USERNAME,userName);
                                                SharePreference.putString(RegActivity.this,PASSWORD,userPassword);
                                            }
